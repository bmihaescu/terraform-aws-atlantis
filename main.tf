locals {
  ...
  secret_name_key = local.has_secrets ? var.atlantis_gitlab_user_token != "" && local.secrets_group == "GITLAB" ? "ATLANTIS_GITLAB_TOKEN" : var.atlantis_github_user_token != "" && local.secrets_group == "GITHUB" ? "ATLANTIS_GH_TOKEN" : "ATLANTIS_BITBUCKET_TOKEN" : "unknown_secret_name_key"
